  ...
  return (
    <div className="flex h-full min-h-full flex-col overflow-hidden">
                        ...
                        {(session as any).is_final ? (
                          ...
                          >
                            ...
                            {pendingOffersCount > 0 && (
                              <Badge
                                variant="secondary"
                                className="absolute -top-2 -end-2 bg-amber-500 text-white border-2 border-white shadow-md h-6 min-w-6 px-1.5 rounded-full text-xs font-bold"
                                title="عروض في انتظار التأكيد"
                              >
                                {pendingOffersCount}
                              </Badge>
                            )}
      ...
      <StockVerificationDialog
        ...
        workerId={selectedWorker}
        onComplete={(payload) => {
          // Show the final review confirmation FIRST, before any refetch re-renders.

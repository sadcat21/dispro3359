  ...
  const groups: FunctionalGroup[] = [
    // 1. المحاسبة والمالية
    {
      ...
      items: [
        ...
        ...(isAdminRole(role) ? [{ path: '/project-manager-treasury', icon: Vault, label: 'خزينة مدير المشروع' }] : []),
    ...
    // 5. العروض والترويج
    {
      ...
      items: [
        ...
        ...(isAdminRole(role) || activeRole?.custom_role_code === 'company_manager' ? [{ path: '/suppliers', icon: Truck, label: t('admin_home.item.suppliers') }] : []),
      ],
    },
    // 6. الموارد البشرية
    {
    ...
    ...(!isBranchAdmin ? [{
      ...
      items: [
        ...
        { path: '/identifier-inspector', icon: ScanSearch, label: t('admin_home.item.identifier_inspector') },

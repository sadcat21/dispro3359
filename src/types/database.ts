export type AppRole = 'admin' | 'worker' | 'supervisor' | 'branch_admin' | 'project_manager' | 'accountant' | 'admin_assistant' | 'warehouse_manager' | 'company_manager' | 'internal_supervisor' | 'external_supervisor';

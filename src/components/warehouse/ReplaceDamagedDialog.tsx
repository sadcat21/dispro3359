  ...
  const confirmAll = async () => {
    ...
    try {
      for (const it of items) {
        ...
        // Add to warehouse damaged_quantity (branch warehouse)
        ...
        const curDamagedPieces = wsRow ? dbToTotalPieces(Number(wsRow.damaged_quantity || 0), ppb) : 0;
        ...
        if (wsRow) {
          ...
          await supabase.from('warehouse_stock').insert({
            ...
            quantity: 0, damaged_quantity: newDamaged,
          });
        }

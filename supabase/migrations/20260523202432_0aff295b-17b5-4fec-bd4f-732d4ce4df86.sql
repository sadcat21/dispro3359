...
BEGIN
  ...
  LOOP
    ...
    -- stock_movements.quantity for movement_type='load' is already in pieces
...
-- Correct the affected worker_stock row: 408 pieces / 20 ppb = 20 boxes + 8 pieces (BP = 20.08)
UPDATE public.worker_stock
SET quantity = 20.08, updated_at = now()

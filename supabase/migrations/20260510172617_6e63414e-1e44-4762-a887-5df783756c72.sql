...
BEGIN
  ...
  LOOP
    ...
    -- Gifts: support both 'box' (boxes.pieces format like 2.02) and 'piece' (raw pieces, possibly boxes.pieces too)
    ...
    v_gift_pieces := CASE
      WHEN COALESCE(v_item.gift_unit, 'piece') = 'box'
        THEN (v_gift_boxes * v_pieces_per_box) + v_gift_piece_part
